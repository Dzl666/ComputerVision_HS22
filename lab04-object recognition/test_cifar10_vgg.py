...
parser.add_argument("--model_path", default='runs/39978/last_model.pkl', type=str)
...
def test(args):
    ...
    test_dataloader = torch.utils.data.DataLoader(dataset=test_dataset, batch_size=args.batch_size, shuffle=False, num_workers=0)
